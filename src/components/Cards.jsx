...
function Cards() {
  return (
    <div className='bg-[#f1f1f1] w-full min-h-screen'>
        <div className='w-full border-t border-zinc-400 mt-52'></div>
        <div className='w-full h-[55vh] translate-y-[30%] gap-5 p flex'>
            <div className='relative w-1/2 h-full rounded-xl bg-[#004d43] ml-16 flex justify-center items-center'>
            <svg width="158.4" height="66" viewBox="0 0 72 30" fill="#cdea68" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <button className='absolute bottom-10 left-10 uppercase text-[#cdea68] font-["Neue_Montreal"] text-xl border-[#cdea68] border-[1px] px-3 py-1 rounded-full'>&copy;2019-2022</button>
            </div>
            <div className='w-1/2 h-full mr-16 flex gap-5'>
                <div className='relative w-1/2 h-full rounded-xl bg-[#212121] flex justify-center items-center'>
                    <img className='scale-125' src='https://ochi.design/wp-content/uploads/2022/04/logo002.svg'/>
                    <button className='absolute bottom-10 left-10 uppercase text-white font-["Neue_Montreal"] text-xl border px-3 py-1 rounded-full'>rating 5.0 on clutch</button>
                </div>
                <div className='relative w-1/2 h-full rounded-xl bg-[#212121] flex justify-center items-center'>
                    <img className='scale-50' src='https://ochi.design/wp-content/uploads/2022/04/logo003.png' />
                    <button className='absolute bottom-10 left-10 uppercase text-white font-["Neue_Montreal"] text-xl border px-3 py-1 rounded-full'>business bootcamp alumni</button>
                </div>
            </div>
        </div>
    </div>
